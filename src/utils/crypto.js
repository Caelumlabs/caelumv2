...
const {
  base58Encode, base58Decode, naclKeypairFromString, naclBoxKeypairFromSecret, naclSeal, naclOpen,
} = require('@polkadot/util-crypto');
const {
  mnemonicGenerate, mnemonicValidate, naclDecrypt, naclEncrypt,
} = require('@polkadot/util-crypto');
const {
  stringToU8a, u8aConcat, u8aToHex, hexToU8a, hexToString, stringToHex,
